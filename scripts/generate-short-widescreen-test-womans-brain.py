...
def main():
    video_id = "womans-brain-fast-test"
    # A highly-engaging, short 45-second widescreen psychological exploration
    brief_text = (
        "POV: We dive into a woman's brain. Only 2 acts total. "
        "Act 1: mess (1 short block: the silent, hyper-active mental threads, micro-analyzing social cues and protecting emotional boundaries). "
        "Act 2: way_forward (1 short block: subtractive preservation - shedding the mental noise, finding quiet peace and emotional clarity). "
    ...
    print("=========================================================")
    print("🎬 THE WOMAN'S BRAIN PSYCHOLOGICAL TEST PIPELINE 🎬")
    print("=========================================================")
    ...
    title = script.get("workingTitle", "Inside a Woman's Brain")
    print(f"Title: {title}")
